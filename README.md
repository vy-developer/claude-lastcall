...
[`plugins/lastcall/lib/lastcall/relay.py`](plugins/lastcall/lib/lastcall/relay.py)
...
```
python3 plugins/lastcall/lib/lastcall/relay.py --dry-run            # print every command
python3 plugins/lastcall/lib/lastcall/relay.py --agent codex --dry-run
```
...
252 tests, standard library only, no network. They cover the failure modes that
